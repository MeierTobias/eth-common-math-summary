...
\noindent\begin{align*}
    ...
    \frac{\partial\; \mathrm{tr}(\mathbf{ABA}^{\mathsf{T}})}{\partial \mathbf{A}} & = 2 \mathbf{AB}                                                                                                 &                  & \mathrm{if}\; \mathbf{B} = \mathbf{B}^{\mathsf{T}} \\
    \frac{\partial\; \mathrm{tr}(\mathbf{AB})}{\partial \mathbf{A}}               & = \mathbf{B}^{\mathsf{T}}                                                                                       &                  & 
\end{align*}
...
\newpar{}
\ptitle{Matrix Inversion Lemma}\label{app:MIL}
\begin{equation*}
    {(\mathbf{A} + \mathbf{BDC})}^{-1} = \mathbf{A}^{-1} - \mathbf{A}^{-1}\mathbf{B}{\left(\mathbf{D} + \mathbf{C}\mathbf{A}^{-1}\mathbf{B}\right)}^{-1}\mathbf{C}\mathbf{A}^{-1}
\end{equation*}